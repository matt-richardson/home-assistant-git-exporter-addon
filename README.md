...
* **Removed deprecated architectures**: `armhf`, `armv7`, and `i386` are no longer built. Only `amd64` and `aarch64` are supported, reflecting the architectures used by current HA hardware.
